            ...
            <div className="flex items-center justify-between">
              <div>
                {event && onDelete && (
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2.5 text-red-400 hover:text-red-300 hover:bg-red-900/20 rounded-lg transition-colors font-medium"
                  >
              ...
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-6 py-2.5 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors font-medium"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-6 py-2.5 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 disabled:cursor-not-allowed text-white rounded-lg transition-colors font-medium min-w-[120px]"
                >
