...
-- Fix 2: Drop and recreate RLS policies to avoid infinite recursion
...
-- Fix 3: Ensure messages policies don't cause recursion
...
-- Fix 4: Update other RPC functions to use explicit parameter names
